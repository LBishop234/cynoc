...
func TestInputPortReadIntoBuffer(t *testing.T) {
	...
	t.Run("FlitInChannel", func(t *testing.T) {
		...
		flit := packet.NewHeaderFlit("t0", packetID, 0, flitPriority, 100, domain.Route{domain.NodeID{ID: "n1"}, domain.NodeID{ID: "n2"}}, zerolog.New(io.Discard))
	...
	t.Run("FullBuffer", func(t *testing.T) {
		...
		flit := packet.NewHeaderFlit("t", "AA", 0, 1, 100, domain.Route{domain.NodeID{ID: "n1"}, domain.NodeID{ID: "n2"}}, zerolog.New(io.Discard))
...
func TestInputPortPeakBuffer(t *testing.T) {
	...
	t.Run("Valid", func(t *testing.T) {
		...
		flit := packet.NewHeaderFlit("t", "AA", 0, 1, 100, domain.Route{domain.NodeID{ID: "n1"}, domain.NodeID{ID: "n2"}, domain.NodeID{ID: "n1"}, domain.NodeID{ID: "n2"}}, zerolog.New(io.Discard))
...
func TestInputPortReadOutOfBuffer(t *testing.T) {
	...
	t.Run("FlitInBuffer", func(t *testing.T) {
		...
		flit := packet.NewHeaderFlit("t", "AA", 0, flitPriority, 100, domain.Route{domain.NodeID{ID: "n1"}, domain.NodeID{ID: "n2"}}, zerolog.New(io.Discard))
		port.buff.addFlit(flit)
