...
func TestNewNetworkInterface(t *testing.T) {
	...
	t.Run("InvalidBufferSize", func(t *testing.T) {
		_, err := newNetworkInterface("i", 0, 1, zerolog.New(io.Discard))
		require.Error(t, err)
	})
}
...
func TestNetworkInterfaceSetInputPort(t *testing.T) {
	...
	t.Run("Valid", func(t *testing.T) {
		...
		netIntfc, err := newNetworkInterface("i", bufferSize, maxPriority, zerolog.New(io.Discard))
		require.NoError(t, err)
...
func TestNetworkInterfaceArrivedHeaderFlit(t *testing.T) {
	...
	t.Run("Valid", func(t *testing.T) {
		...
		headerFlit := packet.NewHeaderFlit("t", "AA", 0, 1, 100, domain.Route{"n1", "n2"}, zerolog.New(io.Discard))
...
func TestNetworkInterfaceTransmitPendingPackets(t *testing.T) {
	...
	t.Run("NoFlitsToTransit", func(t *testing.T) {
		...
		netIntfc, err := newNetworkInterface("i", 1, maxPriority, zerolog.New(io.Discard))
		require.NoError(t, err)
